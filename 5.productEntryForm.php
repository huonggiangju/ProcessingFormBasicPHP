...
<h1>Door Lever Inventory - Part 5</h1>
    ...
    <form method="post" action='5.storeData.php' enctype='multipart/form-data'>
        ...
        <label for="userfile">Upload Product File:</label>
        <input type='file' id='userfile' name='userfile'> 
        <span class="error">* <?php echo $errMessageImage;?></span>
        <br /><br />
